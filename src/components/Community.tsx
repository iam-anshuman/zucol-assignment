...
export function Community(){
    return(
        <div className="bg-white relative">
            ...
            <Image src={"https://res.cloudinary.com/dewj7yvp3/image/upload/v1726386989/Zucol/prsrfwnjrm1bjgsncopd.svg"} width={100} height={100} alt="Pattern Design"  className="absolute -top-52 z-10  my-4 w-full rotate-5"/>
